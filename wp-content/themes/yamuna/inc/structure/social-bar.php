...
if ( ! function_exists( 'yamuna_social_bar' ) ) {
	add_action( 'yamuna_social_bar_action', 'yamuna_social_bar' );
	function yamuna_social_bar() {
		$socials_facebook_url  		=  yamuna_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  yamuna_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  yamuna_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  yamuna_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  yamuna_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  yamuna_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  yamuna_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  yamuna_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  yamuna_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  yamuna_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  yamuna_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  yamuna_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  yamuna_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  yamuna_get_setting( 'socials_mail_url' );
	?>
    <div class="yamuna-social-bar">
    	<ul class="yamuna-socials-list">
