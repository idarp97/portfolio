...
if ( ! function_exists( 'yamuna_archive_title' ) ) {
	add_action( 'yamuna_archive_title', 'yamuna_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function yamuna_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * yamuna_before_archive_title hook.
			 *
			 */
			do_action( 'yamuna_before_archive_title' );
			?>
			...
			<?php
			/**
			 * yamuna_after_archive_title hook.
			 *
			 */
			do_action( 'yamuna_after_archive_title' );
			...
			/**
			 * yamuna_after_archive_description hook.
			 *
			 */
			do_action( 'yamuna_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'yamuna_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'yamuna_filter_the_archive_title' );
	/**
	 ...
	 */
	function yamuna_filter_the_archive_title( $title ) {
		if ( is_category() ) {
